...
<Question>
  ...
  <QuestionContent><Text>1. What exploitation colonialism focuses on?</Text></QuestionContent>
  <AnswerSpecification>
    <SelectionAnswer>
...
<Question>
  ...
  <IsRequired>true</IsRequired>
  <QuestionContent><Text>6. What colonists?</Text></QuestionContent>
  <AnswerSpecification>
    <SelectionAnswer>
      <StyleSuggestion>radiobutton</StyleSuggestion>
      <Selections>
...
<Question>
  ...
  <IsRequired>true</IsRequired>
  <QuestionContent><Text>9. Which does it focus on, colonists or access to resources?</Text></QuestionContent>
  <AnswerSpecification>
    <SelectionAnswer>
      <StyleSuggestion>radiobutton</StyleSuggestion>
      <Selections>
