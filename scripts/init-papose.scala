...
val projectName = "turksem-papose" // make sure it matches the SBT project;
// this is how the .js file is found to send to the server

val annotationPath = java.nio.file.Paths.get(s"data/papose/$label/annotations")
...
val setup = new example.papose.AnnotationSetup(label)
