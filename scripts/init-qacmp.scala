...
// TODO change to "final" when ready
...
val projectName = "turksem-qacmp" // make sure it matches the SBT project;
// this is how the .js file is found to send to the server
val interface = "0.0.0.0"
val httpPort = 8888
val httpsPort = 8080

val annotationPath = java.nio.file.Paths.get(s"data/qacmp/$label/annotations")
...
val setup = new QACmpAnnotationSetup(label)
