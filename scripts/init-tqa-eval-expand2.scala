...
def allTokensForExpansionIter = {
  val filenames = List(
    "qasrl-data/lowerthresh_filtered/base_model_predictions2.fold0.filtered.tsv",
    "qasrl-data/lowerthresh_filtered/base_model_predictions2.fold1.filtered.tsv",
    "qasrl-data/lowerthresh_filtered/base_model_predictions2.fold2.filtered.tsv",
    "qasrl-data/lowerthresh_filtered/base_model_predictions2.fold3.filtered.tsv",
    "qasrl-data/lowerthresh_filtered/base_model_predictions2.fold4.filtered.tsv",
    "qasrl-data/lowerthresh_filtered/base_model_predictions2.dev.filtered.tsv"
  )
...
val trainExpandPrompts = rand.shuffle(
  readPromptsFromFile("qasrl-data/lowerthresh_filtered/base_model_predictions2.fold0.filtered.tsv", "base-fold0") ++
    readPromptsFromFile("qasrl-data/lowerthresh_filtered/base_model_predictions2.fold1.filtered.tsv", "base-fold1") ++
    readPromptsFromFile("qasrl-data/lowerthresh_filtered/base_model_predictions2.fold2.filtered.tsv", "base-fold2") ++
    readPromptsFromFile("qasrl-data/lowerthresh_filtered/base_model_predictions2.fold3.filtered.tsv", "base-fold3") ++
    readPromptsFromFile("qasrl-data/lowerthresh_filtered/base_model_predictions2.fold4.filtered.tsv", "base-fold4")
)
